...
internal static class MonoExtensionManager
{
    ...
    internal static bool RegisterExtension(this IMonoExtension extension)
    {
        ...
        var baseComponent = monoBehaviour.GetComponentInChildren(monoType, true) as MonoBehaviour;
        ...
        var existingExtensions = monoBehaviour.GetComponentsInChildren(extension.GetType(), true);
